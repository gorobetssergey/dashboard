...
<div class="tires-form">
    ...
    <?= $form->field($model, 'type_sales')->dropDownList(Properties::TYPE_SALES,['prompt' => Yii::t('cabinet', 'type_sales')['delivery']['delivery_no']])?>
    <?= $form->field($model, 'old_product')->checkbox(['label' => Yii::t('cabinet', 'type_sales')['old_product']['title']])?>
