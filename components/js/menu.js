$(document).ready(function () {
    ...
    function menu() {
        ...
        var max_show_sub = 0;
        var margin_left_right = 50; //px margin left + margin right
       $("li.ul_menu").hover(function () {
        ...
        function WindowResize() {
            ...
            $(".width_page").css("width", function (i, value) {
                width_bloc = parseInt(value)- margin_left_right;
            });
        ...
        function logicPointer(id_menu, for_max, pointer_position, current_width) {
            pointer_position += margin_left_right/2;
            for(var j=0; j <= for_max; j++){
                if($("li.menu_right").data("left_right") == "left" && j < max_show-1){    //button show menu in left
                    continue;
                }
                $("#"+ j + ".ul_menu").css("width", function (i, li_w) {
                    if(j == id_menu){
            ...
            if($("li.menu_right").data("left_right") == "left"){    //button show menu in left
               pointer_position -= margin_left_right/2;
                // pointer_position += between_button_menu*3;
            }
